...
%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Manage Landmarks</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Landmarks</li>
      </ol>
    </section>
          ...
          <div class="box box-solid bg-light-blue-gradient">
            <div class="box-header">
              ...
              <div class="pull-right box-tools">
                ...
                <button type="button" class="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" style="margin-right: 3px;">
            ...
            <div class="box-body">
              <div id="world-map2" style="height: 600px; width: 100%;"></div>
            </div>
            <!-- /.box-body-->
