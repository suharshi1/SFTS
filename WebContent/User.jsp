...
<%
 	 ...
 	 try{
 		 ...
 		 //Connecting to mysql database
 	 	 ...
 	 	 con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sfts?user=root&password=1234");
 	 
 	 	 //Loading Jasper Report File from Local file System
 	 	 String jrxmlFile1 =session.getServletContext().getRealPath("/User.jrxml");
