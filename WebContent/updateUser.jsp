<!DOCTYPE html>
<%@page import="com.SFTS.Base.Entities.User"%>
<html>
<head>
  <meta charset="utf-8">
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputName" placeholder="Name" value="<%= firstName %>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputLName" placeholder="Last Name" value="<%= firstName %>" >
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputExperience" placeholder="Address">
                    </div>
                   </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" placeholder="DD/MM/YYYY">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" placeholder="Role">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" placeholder="Contact Number">
                    </div>
                  </div>
